...
t.ctx.beginPath();t.ctx.moveTo(t.a[0],t.a[1]);t.ctx.arc(t.a[0],t.a[1],t.a[2],-90*Math.PI/180,t.a[3]*Math.PI/180);t.ctx.closePath();t.ctx.fill();if(t.f||t.a[3]>-90){requestAnimationFrame(function(){t.x30(t);});}else{t.a=[];t.ctx.clearRect(0,0,t.w,t.h);t.d=false;}}};var y={color:false,};$.fn.cshover=function(u,g){y={color:false,}
